...
lm1 <- plm(cases ~  GRP + population, data = litigation_china, index = c('province', 'year'), model = "within")

lm2 <- plm(cases ~ education + population, data = litigation_china, index = c('province', 'year'), model = "within")

lm3 <- plm(cases ~ GRP + education + population, data = litigation_china, index = c('province', 'year'), model = "within")
```
